...
class Hairdressing(models.Model):
    ...
    services_for_face = models.TextField("Услуги для лица", blank=True)
    services_for_body = models.TextField("Услуги для тела", blank=True)
    services_for_eyebrows = models.TextField("Услуги для бровей", blank=True)
    services_for_eyelashes = models.TextField("Услуги для ресниц", blank=True)
    permanent = models.TextField("Перманент", blank=True)
    cosmetology = models.TextField("Косметология", blank=True)
